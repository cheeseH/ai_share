      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
         ...
         <!-- <div class="jumbotron">
          ...
          -->
          <div class="row">
          <?php if(is_array($list)): foreach($list as $key=>$example): ?><div class="col-xs-6 col-lg-4">
                  <h2><?php echo ($example['title']); ?></h2>
                  <p><?php echo ($example['brief']); ?></p>
                  <p><a class="btn btn-default" href="<?php echo U('/Home/example/exampleDetail/id/'.$example[id]);?>" role="button">View details &raquo;</a></p>
                </div><!--/.col-xs-6.col-lg-4--><?php endforeach; endif; ?>
            </div>
            <div class="row">
            <nav aria-label="...">
  <ul class="pagination">
